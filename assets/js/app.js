...
function MaintainUserState(){
    ...
    if(window.sessionStorage.username && window.sessionStorage.plan){
        ...
        document.getElementById('plantext').innerText =  window.sessionStorage.plan ; //Assign session value to element
        document.getElementById('username').innerText = window.sessionStorage.username ; //Assign session value of username to text field
...
function saveUser(){
    ...
    else if(document.getElementById('planForToday')){
        let planForToday = document.getElementById('planForToday').value ; 
        window.sessionStorage.plan = planForToday ;
        document.getElementById('plantext').text =  window.sessionStorage.plan ; //Assign session value to element
